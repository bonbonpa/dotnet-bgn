...
namespace AspMvcTestt.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /// <summary>
        /// Datebbase Store property.
        /// </summary>
        private Test_AuthenDBEntities dbManager = new Test_AuthenDBEntities();
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            try
            {
                ...
                {
                    //Initailization
                    var loginInfo = this.dbManager.LoginByUsernamePassword(model.Username, model.Password).ToList();
                    //Verification
        ...
        private ActionResult LogOff()
        {
            try
            {
                ...
                var authenticationManage = ctx.Authentication;
                //Sign out
